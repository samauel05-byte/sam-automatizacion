document.addEventListener('DOMContentLoaded', () => {
  ...
  <div class="container">
    <div class="footer-grid">
      <div>
        <div class="footer-logo"><img src="assets/logo-mark.png" alt="Logo de SAM Automatización"> SAM AUTOMATIZACIÓN</div>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="servicios.html#analisis-itbis">Análisis de ITBIS</a></li>
